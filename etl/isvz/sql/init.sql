...
CREATE TABLE src_isvz.vestnik_vz (
	rok: SMALLINT,
	id_zadani VARCHAR PRIMARY KEY,
	id_zakazky VARCHAR PRIMARY KEY,
	...
	celkova_konecna_hodnota_vz_za_zadani DECIMAL(18,2),
	celkova_konecna_hodnota_vz_mena_za_zadani CHAR(3),
